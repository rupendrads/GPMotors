          ...
          <React.Fragment key={index}>
            ...
            <div className='flex flex-col items-center text-center flex-1'>
              <div className='mb-2 sm:mb-4'>
                <Image 
                  ...
                  width={80}
                  height={80}
                  className='w-16 h-16 sm:w-16 sm:h-16 lg:w-20 lg:h-20'
                />
              </div>
              <div className='font-bold text-[#626363] text-xs sm:text-sm tracking-wide'>
                {stat.label}
              </div>
            </div>
            ...
            {index < statsData.length - 1 && (
              <div className='flex justify-center'>
                <span className='border-l-2 border-gray-300 h-12 sm:h-16'></span>
              </div>
            )}
          </React.Fragment>
        ))}
