...
const FloatingWhatsApp: React.FC<FloatingWhatsAppProps> = ({ 
  ...
  return (
    <a
      ...
      className={`fixed ${positionClasses[position]} z-50 bg-green-500 hover:bg-green-600 text-white p-4 rounded-full shadow-lg hover:shadow-xl transition-all duration-300 transform hover:scale-110 group`}
