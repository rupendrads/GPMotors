...
import MinorResprayRepairImage from "@/images/car-paintless-dent-repair.png";
...
function MinorResprayRepair() {
  return (
    <Repair
      imageData={MinorResprayRepairImage}
...
export default MinorResprayRepair;
