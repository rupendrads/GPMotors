...
import MinorResprayServiceImage from "@/images/car-dent-repair.png";
...
function MinorRespraySubHeader() {
  return (
    <ServiceSubHeader
      imageData={MinorResprayServiceImage}
...
export default MinorRespraySubHeader;
